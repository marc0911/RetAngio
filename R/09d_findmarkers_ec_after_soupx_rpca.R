...
main <- function() {
  ...
  output_markers <- "results/markers/09d_ec_after_soupx_rpca_findallmarkers.csv"
  output_top10 <- "results/markers/09d_ec_after_soupx_rpca_top10_markers.csv"

  dir.create("results/markers", recursive = TRUE, showWarnings = FALSE)

  message_ts("Starting stage 09d_findmarkers_ec_after_soupx_rpca")
  ...
  message_ts("Stage 09d_findmarkers_ec_after_soupx_rpca complete")
}
