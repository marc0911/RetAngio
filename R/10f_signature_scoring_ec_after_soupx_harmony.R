...
main <- function() {
  ...
  output_rds <- "results/objects/10f_ec_after_soupx_harmony_signature_scored.rds"
  output_sig_used <- "results/signatures/10f_ec_after_soupx_harmony_signatures_used.csv"
  output_cluster_scores <- "results/signatures/10f_ec_after_soupx_harmony_cluster_mean_scores.csv"
  output_cell_scores <- "results/signatures/10f_ec_after_soupx_harmony_cell_scores.csv"
  ...
  message_ts("Starting stage 10f_signature_scoring_ec_after_soupx_harmony")
  ...
  seu@misc$stage10f_signature_scoring <- list(
  ...
  message_ts("Stage 10f_signature_scoring_ec_after_soupx_harmony complete")
}
