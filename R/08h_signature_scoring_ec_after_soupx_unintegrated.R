...
main <- function() {
  input_rds <- "results/objects/08e_ec_after_soupx_unintegrated_final.rds"
  input_xlsx <- "reference/RetAngio_annotation_master_v2.xlsx"

  output_rds <- "results/objects/08h_ec_after_soupx_unintegrated_signature_scored.rds"
  output_sig_used <- "results/signatures/08h_ec_after_soupx_unintegrated_signatures_used.csv"
  output_cluster_scores <- "results/signatures/08h_ec_after_soupx_unintegrated_cluster_mean_scores.csv"
  output_cell_scores <- "results/signatures/08h_ec_after_soupx_unintegrated_cell_scores.csv"
  ...
  message_ts("Starting stage 08h_signature_scoring_ec_after_soupx_unintegrated")
  ...
  # Score signatures one by one to keep metadata names explicit and stable
  ...
  seu@misc$stage08h_signature_scoring <- list(
  ...
  message_ts("Stage 08h_signature_scoring_ec_after_soupx_unintegrated complete")
}
